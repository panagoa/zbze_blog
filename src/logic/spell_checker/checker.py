...
from src.logic.spell_checker.defs import FEATURES_COLUMNS, MODEL_PATH, MODEL_DATA_DIR, WORD_FREQ_FILE_NAME
from src.logic.spell_checker.feature_filler import (
    get_tokenizers_features,
    get_ngram_tresholds_features,
    get_word_trie_features,
)
...
def create_spell_checker_service(
        ...
        word_freq_file_name=WORD_FREQ_FILE_NAME
):
